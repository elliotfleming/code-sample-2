...
*/
	...
	*/
	$config['security']['static_salt'] = 'WxN^!o##20RsWZeW?ZjC;(D(E?Nu4/&U';
	...
	*/
	$config['security']['login_attempt_limit'] = 6;
	...
	*/
	...
	$config['email']['site_title'] = "CrawFinder";
	
	// Reply email shown as 'from' header on emails.
	$config['email']['reply_email'] = "info@crawfinder.com";
	...
	*/
	...
	$config['messages']['delimiters']['status_prefix'] = '<p class="status_msg"><i class="icon-ok"></i> ';
